      ...
      <main>
          ...
          <div className="container">
            <div className="hero-grid">
              <div>
                ...
                <p className="lede">
                  Sales, inventory, finance, and people — connected on a single ledger of record. Built for the way real
                  corporations actually run, with deep roots in property and project-based businesses.
                </p>
        ...
        <section className="trust" aria-label="Customers">
          <div className="container trust-inner">
            <div className="trust-label">Trusted by real corporations worldwide — property-first, built to scale</div>
            <div className="trust-logos">
              {["Kingsway Estates", "Marigold Group", "Lekki Heights", "Sterling Realty", "Adron Homes"].map((name) => (
        ...
        <section className="section" id="modules">
          <div className="container">
            <div className="features-head">
              ...
              <p className="body">
                Every Realcorp module reads from and writes to the same ledger of record. The pipeline closes a deal; the
                payment plan posts to receivables; the audit trail keeps everyone honest. No exports. No reconciliation
                theatre.
              </p>
            </div>
            ...
            <div className="features-grid">
              <FeatureCard
                ...
                items={["WhatsApp & Meta lead capture", "Lead scoring & assignment rules", "Deals, stages, activity feed", "Quote-to-contract handoff"]}
                icon={<UsersIcon />}
              />
              <FeatureCard
                num="02 · Inventory"
                ...
                items={["Project & unit inventory", "Allocation, locking, releases", "Shortlets module", "Floor-plan & price-list links"]}
                icon={<BuildingIcon />}
              />
              <FeatureCard
                num="03 · Finance"
                ...
                items={["Milestone payment plans", "Receivables & payables", "Bank reconciliation", "Vendor bills · audit logs"]}
                icon={<BanknoteIcon />}
              />
              <FeatureCard
                num="04 · People"
                ...
                items={["Bundled onboarding forms", "Offer letters · contracts", "Payslips & deductions", "Departments & reporting lines"]}
                icon={<UserCheckIcon />}
              />
              <FeatureCard
                num="05 · Platform"
                ...
                items={["Isolated tenant workspaces", "Platform console · onboarding", "SSO · role-based access", "Per-tenant branding"]}
                icon={<LayersIcon />}
              />
              <FeatureCard
                num="06 · Marketing"
                ...
                items={["Email & WhatsApp broadcasts", "Embedded lead-capture forms", "Campaign attribution", "Audience segmentation"]}
                icon={<MegaphoneIcon />}
              />
            </div>
          </div>
        ...
        <section className="section" id="how" style={{ paddingTop: 0 }}>
          <div className="container">
            <div className="features-head">
              ...
              <p className="body">
                Onboarding in under a week. Your team keeps using WhatsApp and email the way they always have — Realcorp is
                the system that ties it all together behind the scenes.
              </p>
            </div>
            ...
            <div className="steps">
              <div className="step">
                ...
                <p className="body">
                  Spin up an isolated workspace. We migrate your existing project list, deal history, and chart of accounts.
                  Your team signs in with SSO.
                </p>
              </div>
              <div className="step">
                <div className="num" aria-hidden="true" />
                ...
                <p className="body">
                  Define project units, payment milestones, commission structure, and departments. Bring your floor plans and
                  price lists.
                </p>
              </div>
              <div className="step">
                ...
                <p className="body">
                  Capture leads from WhatsApp and Meta. Move them through the pipeline. Allocate units, post milestones, issue
                  payslips — all in one place.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="cta-block" id="demo">
          <div className="container">
            ...
            <h2 className="headline" style={{ margin: 0, maxWidth: "22ch" }}>
              See Realcorp configured to <em style={{ fontStyle: "italic", color: "var(--accent)" }}>your projects.</em>
            </h2>
            <p className="lede" style={{ textAlign: "center" }}>
              A 30-minute call with a solutions engineer. We&apos;ll bring a workspace pre-loaded with your project list — so
              the demo isn&apos;t generic.
            </p>
          ...
          <div className="footer-grid">
            <div>
              ...
              <p className="body" style={{ marginTop: 14, maxWidth: "38ch", fontSize: "13.5px" }}>
                The operating system for real corporations. Global platform — offices in Lagos, New York, and Dubai.
              </p>
            </div>
            <FooterCol
              title="Product"
