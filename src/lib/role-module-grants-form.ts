...
/**
 * Stored grant tokens — MARKETING/COMMUNITY/FINANCE/CLIENTS map in tenant-nav-access;
 * SALES adds dashboard + projects + leads + deals when org moduleSales is on.
 */
export const EXTRA_MODULE_GRANT_TOKENS = ["SALES", "MARKETING", "COMMUNITY", "FINANCE", "FACILITY", "INVENTORY", "CLIENTS"] as const;
