  ...
  switch (formType) {
    case "BIODATA": {
      ...
      return {
        ...
        ...(d.rsaPin ? { rsaPin: d.rsaPin } : {}),
        ...(d.pensionAdministrator ? { pensionAdministrator: d.pensionAdministrator } : {}),
        ...(d.nhfMembershipNumber ? { nhfMembershipNumber: d.nhfMembershipNumber } : {}),
